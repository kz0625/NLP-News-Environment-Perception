...
if __name__ == "__main__":
    ...
    SimCSE_ckpt = './train_SimCSE/ckpts/{}-final'.format(dataset)
    if dataset == 'Chinese':
        MAX_LEN = 256
    ...
    # --------------------- for news --------------------- #
    output_dir_news = './data/{}/news'.format(dataset)
    if not os.path.exists(output_dir_news):
        os.makedirs(output_dir_news)
    ...
    # --------------------- for post --------------------- #
    output_dir_post = './data/{}/post'.format(dataset)
